...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>Mycms <?php echo PC_VERSION?>  Release <?php echo '';?> [<a href="http://tech.leepine.com" target="_blank"><?php echo L('main_latest_version')?></a>]<br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<?php echo L('main_product_site')?><a href="http://tech.leepine.com/" target="_blank">http://tech.leepine.com/</a> <br />
	<?php echo L('main_product_bbs')?><a href="http://tech.leepine.com/" target="_blank">http://tech.leepine.com/</a> 
	</div>
</div>
...
<!--div class="col-2 col-auto">
	...
	<div class="content">
	<?php //echo L('main_version')?>Mycms <?php //echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://tech.leepine.com" target="_blank"><?php echo L('main_support')?></a>]<br />
